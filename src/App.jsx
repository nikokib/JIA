...
export default function App() {
  ...
  /* Escribe cada respuesta en Firestore, en la colección "respuestas".
     No se guarda ningún dato que identifique al alumno: solo materia,
     contenido, resultado, tiempo de respuesta y región. */
  const registrar = async (r) => {
    setContadorSesion((c) => c + 1); // feedback visual inmediato, no depende de la red
    try {
  ...
  return (
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        {/* mini panel de estado, útil para mostrar en la demo que la
            captura funciona en tiempo real hacia Firestore */}
        {contadorSesion > 0 && !errorGuardado && (
          <div style={{ marginTop: 20, fontFamily: "system-ui, sans-serif", fontSize: 12, color: TOKENS.chalkWhite, opacity: 0.45, textAlign: "center" }}>
            {contadorSesion} respuesta{contadorSesion !== 1 ? "s" : ""} enviada
            {contadorSesion !== 1 ? "s" : ""} a la base de datos en esta sesión
          </div>
        )}
        {errorGuardado && (
          <div style={{ marginTop: 20, fontFamily: "system-ui, sans-serif", fontSize: 12, color: TOKENS.chalkCoral, textAlign: "center" }}>
