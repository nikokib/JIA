...
const BANCO_MATE_7 = [
  ...
  },
  {
   ...
   Nota: los bancos de preguntas de LENGUA para 5.º y 6.º grado
   viven inline dentro del componente ArrastrarPalabras (más abajo,
   banco5/banco6), no como constantes separadas — se eliminaron
   BANCO_LENGUA_5/6/7 por no tener ningún consumidor (deuda técnica
   del prototipo original, PUMM 2026, limpieza 2026-08-24).
   ============================================================ */
